    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-page)" }}>
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
        ...
        <p style={{ color: "var(--text-secondary)" }} className="mb-4">
          EpiRadar collects minimal data: your email and display name from Google OAuth, your plan
          status, and usage logs. We do not sell or share your data with third parties.
        </p>
        <p style={{ color: "var(--text-secondary)" }} className="mb-4">
